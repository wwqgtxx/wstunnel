...
import (
	...
	"github.com/wwqgtxx/wstunnel/utils/list"
)
...
type CreateCallback[K comparable, V any] func(key K) V

func WithCreate[K comparable, V any](cb CreateCallback[K, V]) Option[K, V] {
	return func(l *LruCache[K, V]) {
		l.onCreate = cb
	}
}
